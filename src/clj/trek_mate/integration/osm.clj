...
(defn osm-tags->tags [osm-tags]
  (reduce
   ...
   [
    ...
    #_#(when (= (get % "historic") "castle") tag/tag-history)
    #_#(when (= (get % "historic") "monument") tag/tag-history)
    #_#(when (= (get % "historic") "memorial") tag/tag-history)
    #_#(when (= (get % "historic") "ruins") tag/tag-history)
    #(when (some? (get % "historic")) tag/tag-history)
    ...
    #(when (= (get % "tourism") "camp_site") tag/tag-sleep)
